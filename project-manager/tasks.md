...
- [ ] Configure TypeScript interfaces for Pokemon data
  - [ ] Create Pokemon interface (name, id, sprites, types, stats, height, weight)
  - [ ] Create PokemonSpecies interface (description, flavor_text_entries)
  - [ ] Create PokemonListItem interface (name, url)
- [ ] Setup routing (React Router or similar)
  - [ ] Home route: Pokemon list
  - [ ] Detail route: Pokemon detail page
